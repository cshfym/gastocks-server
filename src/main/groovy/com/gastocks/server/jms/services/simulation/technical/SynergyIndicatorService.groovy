...
class SynergyIndicatorService {
    ...
    boolean rsiConfirmWithMacdCrossover(List<TechnicalQuote> quotes, int index, int periods, String transactionType) {

        TechnicalQuote currentQuote = quotes[index]
    ...
    boolean macdSignalCrossoverPositiveInRange(List<TechnicalQuote> quotes, int startIndex, int endIndex) {
    ...
    boolean macdSignalCrossoverNegativeInRange(List<TechnicalQuote> quotes, int startIndex, int endIndex) {
